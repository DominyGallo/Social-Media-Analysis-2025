...
Through its NDC, each country puts forward its target sectors and its strategy for climate action and sustainable development, which vary widely state by state. Even if all Paris Agreement signatories are legally bound to craft an NDC, there is a relative freedom in how this commitment should be designed, as indicated by the variety of lengths, languages, and formats. Therefore, the way NDCs are organised and worded can reveal information about a country’s priorities and understanding of climate change.
